    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <motion.div variants={{ hidden: { opacity: 0, scale: 0.8 }, visible: { opacity: 1, scale: 1 } }} className="inline-block px-4 py-2 rounded-full bg-cyan-950/50 border border-cyan-500/30 text-cyan-400 font-medium text-sm mb-6 shadow-[0_0_15px_rgba(6,182,212,0.2)]">
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="flex items-center justify-center md:justify-start gap-6 text-slate-400">
              <motion.a whileHover={{ scale: 1.2, translateY: -5, color: '#22d3ee', textShadow: "0 0 10px rgba(34,211,238,0.5)" }} href="#" className="p-3 bg-slate-900/80 rounded-full border border-slate-800 hover:border-cyan-500/50 transition-all"><Linkedin size={20} /></motion.a>
              <motion.a whileHover={{ scale: 1.2, translateY: -5, color: '#22d3ee', textShadow: "0 0 10px rgba(34,211,238,0.5)" }} href="#" className="p-3 bg-slate-900/80 rounded-full border border-slate-800 hover:border-cyan-500/50 transition-all"><Github size={20} /></motion.a>
            </motion.div>
          </motion.div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4 group/item cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-slate-200 font-medium break-all group-hover/item:text-white transition-colors">vanishrishastri0@gmail.com</p>
                  </div>
                </li>
                <li className="flex items-start gap-4 group/item cursor-pointer">
